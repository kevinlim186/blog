...
PAGE_LAYOUTS = {
    ...
    "philippine-garlic-price": philippine_garlic_price,
    'philippine-pork-belly-liempo-price-trend': philippines_pork_belly_price,
}
